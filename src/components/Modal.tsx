...
export default function TransitionsModal({
  ...
  open: boolean;
  setOpen: React.Dispatch<React.SetStateAction<Partial<boolean>>>;
  scoreKept: Partial<ScorePoints>;
  setScoreKept: React.Dispatch<React.SetStateAction<Partial<ScorePoints>>>;
}) {
  const handleClose = () => {
    setOpen(false);
    setScoreKept({});
        ...
        <Fade in={open}>
          <ModalContent sx={style}>
            ...
            <p id="transition-modal-description" className="modal-description">
              Total points:{" "}
              {calculateTotals(scoreKept, "top") +
                calculateTotals(scoreKept, "bottom")}
            </p>
          </ModalContent>
        </Fade>
      </Modal>
